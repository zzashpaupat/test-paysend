 ...
 */
package org.interview.paysend.tables;
...
import org.interview.paysend.Keys;
import org.interview.paysend.Public;
...
public class Account extends TableImpl<AccountRecord> {
    ...
    private static final long serialVersionUID = -435046089;
     ...
     */
    public final TableField<AccountRecord, String> LOGIN = createField(DSL.name("login"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");
     ...
     */
    public final TableField<AccountRecord, BigDecimal> BALANCE = createField(DSL.name("balance"), org.jooq.impl.SQLDataType.NUMERIC(10, 2).nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.NUMERIC)), this, "");
    ...
    public List<UniqueKey<AccountRecord>> getKeys() {
        return Arrays.<UniqueKey<AccountRecord>>asList(Keys.ACCOUNT_PKEY, Keys.LOGIN_UNIQUE);
    }
